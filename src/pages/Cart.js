              ...
              (<Fragment>
               ...
               <div class="cart-item">
                   <div class="row">
                       ...
                       <div class="col-5 col-lg-3 mt-3 mt-lg-0">
                           <div class="stockCounter d-inline">
                               <span onClick={()=> decrease(item)} class="btn btn-danger minus">-</span>
                               <input type="number" class="form-control count d-inline" value={item.qty} readOnly />
   
                               <span onClick={()=> incereaseQty(item)} class="btn btn-primary plus">+</span>
                           </div>
                       </div>
   
                       <div class="col-2 col-md-3 col-lg-1 mt-4 mt-lg-0">
