   ...
   useEffect(()=>{
    ...
    <div className="row f-flex justify-content-around">
        <div className="col-12 col-lg-5 " id="product_image">
            <img src={product.images[0].image} alt="sdf" height="300" width="300"/>
        </div>
        ...
        <div className="col-12 col-lg-5 mt-5">
            ...
            <div className="stockCounter d-inline">
                <span onClick={decrease} className="btn btn-danger minus">-</span>

                <input type="number" className="form-control count d-inline" value={qty} readOnly />

                <span onClick={incereaseQty} className="btn btn-primary plus">+</span>
            </div>
